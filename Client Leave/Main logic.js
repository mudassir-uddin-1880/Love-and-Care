...
var currentTime = currDateAndTime.split(' ')[1];
...
// Add currentTime to reassignedSchedules
for (var i = 0; i < result.reassignedSchedules.length; i++) {
    result.reassignedSchedules[i].currentTime = currentTime;
    result.reassignedSchedules[i].automationcaregiver = "Yes";
}

// Add currentTime to unassignedSchedules
for (var i = 0; i < result.unassignedSchedules.length; i++) {
    result.unassignedSchedules[i].currentTime = currentTime;
    result.unassignedSchedules[i].automationcaregiver = "Yes";
}
