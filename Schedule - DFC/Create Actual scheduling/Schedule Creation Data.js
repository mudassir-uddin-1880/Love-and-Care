...
var currDateAndTime = input.currDateAndTime || ""; // e.g. "2025-12-10 10:55:41"
...
for (var s = 0; s < sourceSchedules.length; s++) {
    ...
    // Add currentTime only for open shifts
    if (sched.shiftStatus === "Open Shift") {
        var timeOnly = currDateAndTime // Extract time part (e.g., "10:55:41")
        merged.currentTime = timeOnly;
    } else {
        merged.currentTime = null; // Or use an empty string ""
    }
